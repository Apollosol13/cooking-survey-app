...
function App() {
  ...
  if (showVideo) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="bg-gray-900 rounded-2xl shadow-xl p-8 max-w-2xl w-full border border-gray-700 text-center">
          <h2 className="text-2xl font-bold text-white mb-6">See How We Solve Your Pain Point</h2>
          <div className="mb-6 flex justify-center">
            <iframe
              width="360"
              height="640"
              src="https://www.youtube.com/embed/Q_fCgpZvpBQ"
